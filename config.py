...
class Config:
    def __init__(self):
        ...
        self.API_KEY = getenv("API_KEY", "e79e1f_TteYan9u6XM9NpDSAOGhkpQejHdUzeFA")
        ...
        self.PING_IMG = getenv("PING_IMG", "https://telegra.ph/SMDBOTZ-03-03-2")
        self.START_IMG = getenv("START_IMG", "https://telegra.ph/SMDBOTZ-03-03-3")
